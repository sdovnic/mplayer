...
void 0});return Z=d.now()}function pa(a,b){var c,d=0,f={height:a};for(b=b?1:0;4>d;d+=2-b)c=K[d],f["margin"+c]=f["padding"+c]=a;b&&(f.opacity=f.width=a);return f}function ib(a,b,c){for(var d,f=(Q[b]||[]).concat(Q["*"]),g=0,h=f.length;g<h;g++)if(d=f[g].call(c,b,a))return d}function Rb(a,b){var c,e,f,g,h;for(c in a)if(e=d.camelCase(c),f=b[e],g=a[c],d.isArray(g)&&(f=g[1],g=a[c]=g[0]),c!==e&&(a[e]=g,delete a[c]),(h=d.cssHooks[e])&&"expand"in h)for(c in g=h.expand(g),delete a[e],g)c in a||(a[c]=g[c],b[c]=
...
!g["*"]&&f("*")}function Ia(a,b){var c,e,f=d.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((f[c]?a:e||(e={}))[c]=b[c]);e&&d.extend(!0,a,e);return a}function Ja(a,b,c,e){var f;if(d.isArray(b))d.each(b,function(b,d){c||Sb.test(a)?e(a,d):Ja(a+"["+("object"===typeof d?b:"")+"]",d,c,e)});else if(c||"object"!==d.type(b))e(a,b);else for(f in b)Ja(a+"["+f+"]",b[f],c,e)}function mb(a){return d.isWindow(a)?a:9===a.nodeType&&a.defaultView}var $=[],N=$.slice,nb=$.concat,Ka=$.push,la=$.indexOf,aa={},
Tb=aa.toString,La=aa.hasOwnProperty,w={},s=u.document,d=function(a,b){return new d.fn.init(a,b)},Ub=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Vb=/^-ms-/,Wb=/-([\da-z])/gi,Xb=function(a,b){return b.toUpperCase()};d.fn=d.prototype={jquery:"2.1.1",constructor:d,selector:"",length:0,toArray:function(){return N.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:N.call(this)},pushStack:function(a){a=d.merge(this.constructor(),a);a.prevObject=this;a.context=this.context;return a},each:function(a,
...
typeof a},globalEval:function(a){var b;b=eval;if(a=d.trim(a))1===a.indexOf("use strict")?(b=s.createElement("script"),b.text=a,s.head.appendChild(b).parentNode.removeChild(b)):b(a)},camelCase:function(a){return a.replace(Vb,"ms-").replace(Wb,Xb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var d,f=0,g=a.length;d=Ca(a);if(c)if(d)for(;f<g&&(d=b.apply(a[f],c),!1!==d);f++);else for(f in a){if(d=b.apply(a[f],c),!1===d)break}else if(d)for(;f<
g&&(d=b.call(a[f],f,a[f]),!1!==d);f++);else for(f in a)if(d=b.call(a[f],f,a[f]),!1===d)break;return a},trim:function(a){return null==a?"":(a+"").replace(Ub,"")},makeArray:function(a,b){var c=b||[];null!=a&&(Ca(Object(a))?d.merge(c,"string"===typeof a?[a]:a):Ka.call(c,a));return c},inArray:function(a,b,c){return null==b?-1:la.call(b,a,c)},merge:function(a,b){for(var c=+b.length,d=0,f=a.length;d<c;d++)a[f++]=b[d];a.length=f;return a},grep:function(a,b,c){for(var d=[],f=0,g=a.length,h=!c;f<g;f++)c=!b(a[f],
...
d.length+1)===d+"-":!1}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,k){var l,m,p,q,t;c=f!==g?"nextSibling":"previousSibling";var n=b.parentNode,ob=h&&b.nodeName.toLowerCase();k=!k&&!h;if(n){if(f){for(;c;){for(m=b;m=m[c];)if(h?m.nodeName.toLowerCase()===ob:1===m.nodeType)return!1;t=c="only"===a&&!t&&"nextSibling"}return!0}t=[g?n.firstChild:n.lastChild];if(g&&k)for(k=n[E]||(n[E]={}),l=
k[a]||[],q=l[0]===I&&l[1],p=l[0]===I&&l[2],m=q&&n.childNodes[q];m=++q&&m&&m[c]||(p=q=0)||t.pop();){if(1===m.nodeType&&++p&&m===b){k[a]=[I,q,p];break}}else if(k&&(l=(b[E]||(b[E]={}))[a])&&l[0]===I)p=l[1];else for(;(m=++q&&m&&m[c]||(p=q=0)||t.pop())&&((h?m.nodeName.toLowerCase()!==ob:1!==m.nodeType)||!++p||(k&&((m[E]||(m[E]={}))[a]=[I,p]),m!==b)););p-=e;return p===d||0===p%d&&0<=p/d}}},PSEUDO:function(a,c){var f,g=r.pseudos[a]||r.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return g[E]?
...
h),k.push(f=[]);d=!1;if(e=ka.exec(h))d=e.shift(),f.push({value:d,type:e[0].replace(Q," ")}),h=h.slice(d.length);for(g in r.filter)!(e=T[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),h=h.slice(d.length));if(!d)break}return c?h.length:h?b.error(a):O(a,k).slice(0)};Na=b.compile=function(a,b){var c,d=[],e=[],f=P[a+" "];if(!f){b||(b=ua(a));for(c=b.length;c--;)f=w(b[c]),f[E]?d.push(f):e.push(f);f=P(a,G(e,d));f.selector=a}return f};A=b.select=function(a,b,c,d){var e,f,
...
c===k?g.notifyWith(b,c):--f||g.resolveWith(b,c)}},k,l,p;if(1<e)for(k=Array(e),l=Array(e),p=Array(e);b<e;b++)c[b]&&d.isFunction(c[b].promise)?c[b].promise().done(h(b,p,c)).fail(g.reject).progress(h(b,l,k)):--f;f||g.resolveWith(p,c);return g.promise()}});var wa;d.fn.ready=function(a){d.ready.promise().done(a);return this};d.extend({isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){(!0===a?--d.readyWait:d.isReady)||(d.isReady=!0,!0!==a&&0<--d.readyWait||(wa.resolveWith(s,
[d]),d.fn.triggerHandler&&(d(s).triggerHandler("ready"),d(s).off("ready"))))}});d.ready.promise=function(a){wa||(wa=d.Deferred(),"complete"===s.readyState?setTimeout(d.ready):(s.addEventListener("DOMContentLoaded",ma,!1),u.addEventListener("load",ma,!1)));return wa.promise(a)};d.ready.promise();var O=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,p=null==c;if("object"===d.type(c))for(k in f=!0,c)d.access(a,b,k,c[k],!0,g,h);else if(void 0!==e&&(f=!0,d.isFunction(e)||(h=!0),p&&(h?(b.call(a,e),
...
b)this.cache[c]={};else for(d.isArray(b)?e=b.concat(b.map(d.camelCase)):(c=d.camelCase(b),b in f?e=[b,c]:(e=c,e=e in f?[e]:e.match(L)||[])),c=e.length;c--;)delete f[e[c]]},hasData:function(a){return!d.isEmptyObject(this.cache[a[this.expando]]||{})},discard:function(a){a[this.expando]&&delete this.cache[a[this.expando]]}};var n=new M,G=new M,Mb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Lb=/([A-Z])/g;d.extend({hasData:function(a){return G.hasData(a)||n.hasData(a)},data:function(a,b,c){return G.access(a,b,c)},
removeData:function(a,b){G.remove(a,b)},_data:function(a,b,c){return n.access(a,b,c)},_removeData:function(a,b){n.remove(a,b)}});d.fn.extend({data:function(a,b){var c,e,f,g=this[0],h=g&&g.attributes;if(void 0===a){if(this.length&&(f=G.get(g),1===g.nodeType&&!n.get(g,"hasDataAttrs"))){for(c=h.length;c--;)h[c]&&(e=h[c].name,0===e.indexOf("data-")&&(e=d.camelCase(e.slice(5)),Ua(g,e,f[e])));n.set(g,"hasDataAttrs",!0)}return f}return"object"===typeof a?this.each(function(){G.set(this,a)}):O(this,function(b){var c,
e=d.camelCase(a);if(g&&void 0===b){c=G.get(g,a);if(void 0!==c)return c;c=G.get(g,e);if(void 0!==c)return c;c=Ua(g,e,void 0);if(void 0!==c)return c}else this.each(function(){var c=G.get(this,e);G.set(this,e,b);-1!==a.indexOf("-")&&void 0!==c&&G.set(this,a,b)})},null,b,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){G.remove(this,a)})}});d.extend({queue:function(a,b,c){var e;if(a)return b=(b||"fx")+"queue",e=n.get(a,b),c&&(!e||d.isArray(c)?e=n.access(a,b,d.makeArray(c)):
...
c.empty&&(e++,c.empty.add(k));k();return f.promise(b)}});var za=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,K=["Top","Right","Bottom","Left"],U=function(a,b){a=b||a;return"none"===d.css(a,"display")||!d.contains(a.ownerDocument,a)},sb=/^(?:checkbox|radio)$/i;(function(){var a=s.createDocumentFragment().appendChild(s.createElement("div")),b=s.createElement("input");b.setAttribute("type","radio");b.setAttribute("checked","checked");b.setAttribute("name","t");a.appendChild(b);w.checkClone=a.cloneNode(!0).cloneNode(!0).lastChild.checked;
a.innerHTML="<textarea>x</textarea>";w.noCloneChecked=!!a.cloneNode(!0).lastChild.defaultValue})();w.focusinBubbles="onfocusin"in u;var ac=/^key/,bc=/^(?:mouse|pointer|contextmenu)|click/,tb=/^(?:focusinfocus|focusoutblur)$/,ub=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,p,q,m,t,y;if(p=n.get(a))for(c.handler&&(g=c,c=g.handler,f=g.selector),c.guid||(c.guid=d.guid++),(l=p.events)||(l=p.events={}),(h=p.handle)||(h=p.handle=function(b){return"undefined"!==typeof d&&d.event.triggered!==
b.type?d.event.dispatch.apply(a,arguments):void 0}),b=(b||"").match(L)||[""],p=b.length;p--;)k=ub.exec(b[p])||[],t=q=k[1],y=(k[2]||"").split(".").sort(),t&&(k=d.event.special[t]||{},t=(f?k.delegateType:k.bindType)||t,k=d.event.special[t]||{},q=d.extend({type:t,origType:q,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:y.join(".")},g),(m=l[t])||(m=l[t]=[],m.delegateCount=0,k.setup&&!1!==k.setup.call(a,e,y,h)||a.addEventListener&&a.addEventListener(t,
h,!1)),k.add&&(k.add.call(a,q),q.handler.guid||(q.handler.guid=c.guid)),f?m.splice(m.delegateCount++,0,q):m.push(q),d.event.global[t]=!0)},remove:function(a,b,c,e,f){var g,h,k,l,p,q,m,t,y,s,u,w=n.hasData(a)&&n.get(a);if(w&&(l=w.events)){b=(b||"").match(L)||[""];for(p=b.length;p--;)if(k=ub.exec(b[p])||[],y=u=k[1],s=(k[2]||"").split(".").sort(),y){m=d.event.special[y]||{};y=(e?m.delegateType:m.bindType)||y;t=l[y]||[];k=k[2]&&RegExp("(^|\\.)"+s.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=t.length;g--;)q=
t[g],!f&&u!==q.origType||c&&c.guid!==q.guid||k&&!k.test(q.namespace)||e&&!(e===q.selector||"**"===e&&q.selector)||(t.splice(g,1),q.selector&&t.delegateCount--,m.remove&&m.remove.call(a,q));h&&!t.length&&(m.teardown&&!1!==m.teardown.call(a,s,w.handle)||d.removeEvent(a,y,w.handle),delete l[y])}else for(y in l)d.event.remove(a,y+b[p],c,e,!0);d.isEmptyObject(l)&&(delete w.handle,n.remove(a,"events"))}},trigger:function(a,b,c,e){var f,g,h,k,l,p,q=[c||s],m=La.call(a,"type")?a.type:a;p=La.call(a,"namespace")?
a.namespace.split("."):[];g=f=c=c||s;if(3!==c.nodeType&&8!==c.nodeType&&!tb.test(m+d.event.triggered)&&(0<=m.indexOf(".")&&(p=m.split("."),m=p.shift(),p.sort()),k=0>m.indexOf(":")&&"on"+m,a=a[d.expando]?a:new d.Event(m,"object"===typeof a&&a),a.isTrigger=e?2:3,a.namespace=p.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,a.result=void 0,a.target||(a.target=c),b=null==b?[a]:d.makeArray(b,[a]),p=d.event.special[m]||{},e||!p.trigger||!1!==p.trigger.apply(c,
...
isSimulated:!0,originalEvent:{}});e?d.event.trigger(a,null,b):d.event.dispatch.call(b,a);a.isDefaultPrevented()&&c.preventDefault()}};d.removeEvent=function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)};d.Event=function(a,b){if(!(this instanceof d.Event))return new d.Event(a,b);a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||void 0===a.defaultPrevented&&!1===a.returnValue?na:X):this.type=a;b&&d.extend(this,b);this.timeStamp=a&&a.timeStamp||
...
11!==a.nodeType||d.isXMLDoc(a)))for(h=x(k),g=x(a),e=0,f=g.length;e<f;e++){var p=g[e],n=h[e],m=n.nodeName.toLowerCase();if("input"===m&&sb.test(p.type))n.checked=p.checked;else if("input"===m||"textarea"===m)n.defaultValue=p.defaultValue}if(b)if(c)for(g=g||x(a),h=h||x(k),e=0,f=g.length;e<f;e++)Xa(g[e],h[e]);else Xa(a,k);h=x(k,"script");0<h.length&&Ea(h,!l&&x(a,"script"));return k},buildFragment:function(a,b,c,e){for(var f,g,h,k=b.createDocumentFragment(),l=[],p=0,n=a.length;p<n;p++)if((f=a[p])||0===
f)if("object"===d.type(f))d.merge(l,f.nodeType?[f]:f);else if(cc.test(f)){g=g||k.appendChild(b.createElement("div"));h=(wb.exec(f)||["",""])[1].toLowerCase();h=z[h]||z._default;g.innerHTML=h[1]+f.replace(vb,"<$1></$2>")+h[2];for(h=h[0];h--;)g=g.lastChild;d.merge(l,g.childNodes);g=k.firstChild;g.textContent=""}else l.push(b.createTextNode(f));k.textContent="";for(p=0;f=l[p++];)if(!e||-1===d.inArray(f,e))if(a=d.contains(f.ownerDocument,f),g=x(k.appendChild(f),"script"),a&&Ea(g),c)for(h=0;f=g[h++];)xb.test(f.type||
"")&&c.push(f);return k},cleanData:function(a){for(var b,c,e,f,g=d.event.special,h=0;void 0!==(c=a[h]);h++){if(d.acceptData(c)&&(f=c[n.expando])&&(b=n.cache[f])){if(b.events)for(e in b.events)g[e]?d.event.remove(c,e):d.removeEvent(c,e,b.handle);n.cache[f]&&delete n.cache[f]}delete G.cache[c[G.expando]]}}});d.fn.extend({text:function(a){return O(this,function(a){return void 0===a?d.text(this):this.empty().each(function(){if(1===this.nodeType||11===this.nodeType||9===this.nodeType)this.textContent=
...
function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,e=a?d.filter(a,this):this,f=0;null!=(c=e[f]);f++)b||1!==c.nodeType||d.cleanData(x(c)),c.parentNode&&(b&&d.contains(c.ownerDocument,c)&&Ea(x(c,"script")),c.parentNode.removeChild(c));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++)1===a.nodeType&&(d.cleanData(x(a,!1)),a.textContent="");return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return d.clone(this,
a,b)})},html:function(a){return O(this,function(a){var c=this[0]||{},e=0,f=this.length;if(void 0===a&&1===c.nodeType)return c.innerHTML;if("string"===typeof a&&!dc.test(a)&&!z[(wb.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(vb,"<$1></$2>");try{for(;e<f;e++)c=this[e]||{},1===c.nodeType&&(d.cleanData(x(c,!1)),c.innerHTML=a);c=0}catch(g){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];this.domManip(arguments,function(b){a=this.parentNode;d.cleanData(x(this));
a&&a.replaceChild(b,this)});return a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=nb.apply([],a);var c,e,f,g,h=0,k=this.length,l=this,p=k-1,q=a[0],m=d.isFunction(q);if(m||1<k&&"string"===typeof q&&!w.checkClone&&ec.test(q))return this.each(function(c){var d=l.eq(c);m&&(a[0]=q.call(this,c,d.html()));d.domManip(a,b)});if(k&&(c=d.buildFragment(a,this[0].ownerDocument,!1,this),e=c.firstChild,1===c.childNodes.length&&(c=e),e)){e=d.map(x(c,
...
[],f=d(a),g=f.length-1,h=0;h<=g;h++)a=h===g?this:this.clone(!0),d(f[h])[b](a),Ka.apply(e,a.get());return this.pushStack(e)}});var T,Za={},$a=/^margin/,Ga=RegExp("^("+za+")(?!px)[a-z%]+$","i"),oa=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)};(function(){function a(){g.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute";g.innerHTML="";e.appendChild(f);
var a=u.getComputedStyle(g,null);b="1%"!==a.top;c="4px"===a.width;e.removeChild(f)}var b,c,e=s.documentElement,f=s.createElement("div"),g=s.createElement("div");g.style&&(g.style.backgroundClip="content-box",g.cloneNode(!0).style.backgroundClip="",w.clearCloneStyle="content-box"===g.style.backgroundClip,f.style.cssText="border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute",f.appendChild(g),u.getComputedStyle&&d.extend(w,{pixelPosition:function(){a();return b},boxSizingReliable:function(){null==
...
d||[]);for(f in b)a.style[f]=g[f];return c};var gc=/^(none|table(?!-c[ea]).+)/,Qb=RegExp("^("+za+")(.*)$","i"),hc=RegExp("^([+-])=("+za+")","i"),ic={position:"absolute",visibility:"hidden",display:"block"},yb={letterSpacing:"0",fontWeight:"400"},cb=["Webkit","O","Moz","ms"];d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Y(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,
zIndex:!0,zoom:!0},cssProps:{"float":"cssFloat"},style:function(a,b,c,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,k=d.camelCase(b),l=a.style;b=d.cssProps[k]||(d.cssProps[k]=bb(l,k));h=d.cssHooks[b]||d.cssHooks[k];if(void 0!==c)g=typeof c,"string"===g&&(f=hc.exec(c))&&(c=(f[1]+1)*f[2]+parseFloat(d.css(a,b)),g="number"),null!=c&&c===c&&("number"!==g||d.cssNumber[k]||(c+="px"),w.clearCloneStyle||""!==c||0!==b.indexOf("background")||(l[b]="inherit"),h&&"set"in h&&void 0===(c=h.set(a,c,
e))||(l[b]=c));else return h&&"get"in h&&void 0!==(f=h.get(a,!1,e))?f:l[b]}},css:function(a,b,c,e){var f,g;g=d.camelCase(b);b=d.cssProps[g]||(d.cssProps[g]=bb(a.style,g));(g=d.cssHooks[b]||d.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,c));void 0===f&&(f=Y(a,b,e));"normal"===f&&b in yb&&(f=yb[b]);return""===c||c?(a=parseFloat(f),!0===c||d.isNumeric(a)?a||0:f):f}});d.each(["height","width"],function(a,b){d.cssHooks[b]={get:function(a,e,f){if(e)return gc.test(d.css(a,"display"))&&0===a.offsetWidth?d.swap(a,
ic,function(){return fb(a,b,f)}):fb(a,b,f)},set:function(a,e,f){var g=f&&oa(a);return db(a,e,f?eb(a,b,f,"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.cssHooks.marginRight=ab(w.reliableMarginRight,function(a,b){if(b)return d.swap(a,{display:"inline-block"},Y,[a,"marginRight"])});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,f={};for(c="string"===typeof c?c.split(" "):[c];4>d;d++)f[a+K[d]+b]=c[d]||c[d-2]||c[0];return f}};$a.test(a)||(d.cssHooks[a+
b].set=db)});d.fn.extend({css:function(a,b){return O(this,function(a,b,f){var g,h={},k=0;if(d.isArray(b)){f=oa(a);for(g=b.length;k<g;k++)h[b[k]]=d.css(a,b[k],!1,f);return h}return void 0!==f?d.style(a,b,f):d.css(a,b)},a,b,1<arguments.length)},show:function(){return gb(this,!0)},hide:function(){return gb(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){U(this)?d(this).show():d(this).hide()})}});d.Tween=A;A.prototype={constructor:A,init:function(a,
...
A.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};d.fx=A.prototype.init;d.fx.step={};var Z,Aa,jc=/^(?:toggle|show|hide)$/,zb=RegExp("^(?:([+-])=|)("+za+")([a-z%]*)$","i"),kc=/queueHooks$/,qa=[function(a,b,c){var e,f,g,h,k,l,p=this,q={},m=a.style,t=a.nodeType&&U(a),s=n.get(a,"fxshow");c.queue||(h=d._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,k=h.empty.fire,
...
c.overflow[2]}));for(e in b)if(f=b[e],jc.exec(f)){delete b[e];g=g||"toggle"===f;if(f===(t?"hide":"show"))if("show"===f&&s&&void 0!==s[e])t=!0;else continue;q[e]=s&&s[e]||d.style(a,e)}else l=void 0;if(d.isEmptyObject(q))"inline"===("none"===l?Fa(a.nodeName):l)&&(m.display=l);else for(e in s?"hidden"in s&&(t=s.hidden):s=n.access(a,"fxshow",{}),g&&(s.hidden=!t),t?d(a).show():p.done(function(){d(a).hide()}),p.done(function(){var b;n.remove(a,"fxshow");for(b in q)d.style(a,b,q[b])}),q)b=ib(t?s[e]:0,e,
p),e in s||(s[e]=b.start,t&&(b.end=b.start,b.start="width"===e||"height"===e?1:0))}],Q={"*":[function(a,b){var c=this.createTween(a,b),e=c.cur(),f=zb.exec(b),g=f&&f[3]||(d.cssNumber[a]?"":"px"),h=(d.cssNumber[a]||"px"!==g&&+e)&&zb.exec(d.css(c.elem,a)),k=1,l=20;if(h&&h[3]!==g){g=g||h[3];f=f||[];h=+e||1;do k=k||".5",h/=k,d.style(c.elem,a,h+g);while(k!==(k=c.cur()/e)&&1!==k&&--l)}f&&(h=c.start=+h||+e||0,c.unit=g,c.end=f[1]?h+(f[1]+1)*f[2]:+f[2]);return c}]};d.Animation=d.extend(jb,{tweener:function(a,
...
a.stop;delete a.stop;b(c)};"string"!==typeof a&&(c=b,b=a,a=void 0);b&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b=!0,g=null!=a&&a+"queueHooks",h=d.timers,k=n.get(this);if(g)k[g]&&k[g].stop&&e(k[g]);else for(g in k)k[g]&&k[g].stop&&kc.test(g)&&e(k[g]);for(g=h.length;g--;)h[g].elem!==this||null!=a&&h[g].queue!==a||(h[g].anim.stop(c),b=!1,h.splice(g,1));!b&&c||d.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var b,c=n.get(this),e=c[a+"queue"];
b=c[a+"queueHooks"];var f=d.timers,g=e?e.length:0;c.finish=!0;d.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;b<g;b++)e[b]&&e[b].finish&&e[b].finish.call(this);delete c.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,g){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(pa(b,!0),a,d,g)}});d.each({slideDown:pa("show"),slideUp:pa("hide"),
slideToggle:pa("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(a,d,f){return this.animate(b,a,d,f)}});d.timers=[];d.fx.tick=function(){var a,b=0,c=d.timers;for(Z=d.now();b<c.length;b++)a=c[b],a()||c[b]!==a||c.splice(b--,1);c.length||d.fx.stop();Z=void 0};d.fx.timer=function(a){d.timers.push(a);a()?d.fx.start():d.timers.pop()};d.fx.interval=13;d.fx.start=function(){Aa||(Aa=setInterval(d.fx.tick,d.fx.interval))};d.fx.stop=function(){clearInterval(Aa);
Aa=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){a=d.fx?d.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,d){var f=setTimeout(b,a);d.stop=function(){clearTimeout(f)}})};(function(){var a=s.createElement("input"),b=s.createElement("select"),c=b.appendChild(s.createElement("option"));a.type="checkbox";w.checkOn=""!==a.value;w.optSelected=c.selected;b.disabled=!0;w.optDisabled=!c.disabled;a=s.createElement("input");a.value="t";a.type="radio";w.radioValue="t"===a.value})();
var Ab,ja=d.expr.attrHandle;d.fn.extend({attr:function(a,b){return O(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})}});d.extend({attr:function(a,b,c){var e,f,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g){if("undefined"===typeof a.getAttribute)return d.prop(a,b,c);1===g&&d.isXMLDoc(a)||(b=b.toLowerCase(),e=d.attrHooks[b]||(d.expr.match.bool.test(b)?Ab:void 0));if(void 0!==c)if(null===c)d.removeAttr(a,b);else{if(e&&"set"in e&&void 0!==(f=e.set(a,
c,b)))return f;a.setAttribute(b,c+"");return c}else{if(e&&"get"in e&&null!==(f=e.get(a,b)))return f;f=d.find.attr(a,b);return null==f?void 0:f}}},removeAttr:function(a,b){var c,e,f=0,g=b&&b.match(L);if(g&&1===a.nodeType)for(;c=g[f++];)e=d.propFix[c]||c,d.expr.match.bool.test(c)&&(a[e]=!1),a.removeAttribute(c)},attrHooks:{type:{set:function(a,b){if(!w.radioValue&&"radio"===b&&d.nodeName(a,"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}}}});Ab={set:function(a,b,c){!1===b?
d.removeAttr(a,c):a.setAttribute(c,c);return c}};d.each(d.expr.match.bool.source.match(/\w+/g),function(a,b){var c=ja[b]||d.find.attr;ja[b]=function(a,b,d){var h,k;d||(k=ja[b],ja[b]=h,h=null!=c(a,b,d)?b.toLowerCase():null,ja[b]=k);return h}});var lc=/^(?:input|select|textarea|button)$/i;d.fn.extend({prop:function(a,b){return O(this,d.prop,a,b,1<arguments.length)},removeProp:function(a){return this.each(function(){delete this[d.propFix[a]||a]})}});d.extend({propFix:{"for":"htmlFor","class":"className"},
prop:function(a,b,c){var e,f,g;g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g){if(g=1!==g||!d.isXMLDoc(a))b=d.propFix[b]||b,f=d.propHooks[b];return void 0!==c?f&&"set"in f&&void 0!==(e=f.set(a,c,b))?e:a[b]=c:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){return a.hasAttribute("tabindex")||lc.test(a.nodeName)||a.href?a.tabIndex:-1}}}});w.optSelected||(d.propHooks.selected={get:function(a){(a=a.parentNode)&&a.parentNode&&a.parentNode.selectedIndex;return null}});d.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),
function(){d.propFix[this.toLowerCase()]=this});var Oa=/[\t\r\n\f]/g;d.fn.extend({addClass:function(a){var b,c,e,f,g;b="string"===typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(L)||[];h<k;h++)if(c=this[h],e=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Oa," "):" ")){for(g=0;f=b[g++];)0>e.indexOf(" "+f+" ")&&(e+=f+" ");e=d.trim(e);c.className!==e&&(c.className=e)}return this},
removeClass:function(a){var b,c,e,f,g;b=0===arguments.length||"string"===typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(L)||[];h<k;h++)if(c=this[h],e=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Oa," "):"")){for(g=0;f=b[g++];)for(;0<=e.indexOf(" "+f+" ");)e=e.replace(" "+f+" "," ");e=a?d.trim(e):"";c.className!==e&&(c.className=e)}return this},toggleClass:function(a,b){var c=
...
a);return b};var S,P,nc=/#.*$/,Bb=/([?&])_=[^&]*/,oc=/^(.*?):[ \t]*([^\r\n]*)$/mg,pc=/^(?:GET|HEAD)$/,qc=/^\/\//,Cb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Db={},Ha={},Eb="*/".concat("*");try{P=location.href}catch(yc){P=s.createElement("a"),P.href="",P=P.href}S=Cb.exec(P.toLowerCase())||[];d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:P,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(S[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",
accepts:{"*":Eb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Ia(Ia(a,d.ajaxSettings),b):Ia(d.ajaxSettings,a)},ajaxPrefilter:kb(Db),ajaxTransport:kb(Ha),ajax:function(a,
b){function c(a,b,c,h){var l,n,q,v;v=b;if(2!==J){J=2;k&&clearTimeout(k);e=void 0;g=h||"";r.readyState=0<a?4:0;h=200<=a&&300>a||304===a;if(c){q=m;for(var B=r,H,x,D,F,A=q.contents,z=q.dataTypes;"*"===z[0];)z.shift(),void 0===H&&(H=q.mimeType||B.getResponseHeader("Content-Type"));if(H)for(x in A)if(A[x]&&A[x].test(H)){z.unshift(x);break}if(z[0]in c)D=z[0];else{for(x in c){if(!z[0]||q.converters[x+" "+z[0]]){D=x;break}F||(F=x)}D=D||F}D?(D!==z[0]&&z.unshift(D),q=c[D]):q=void 0}a:{c=m;H=q;x=r;D=h;var E,
C,I,B={},A=c.dataTypes.slice();if(A[1])for(C in c.converters)B[C.toLowerCase()]=c.converters[C];for(F=A.shift();F;)if(c.responseFields[F]&&(x[c.responseFields[F]]=H),!I&&D&&c.dataFilter&&(H=c.dataFilter(H,c.dataType)),I=F,F=A.shift())if("*"===F)F=I;else if("*"!==I&&I!==F){C=B[I+" "+F]||B["* "+F];if(!C)for(E in B)if(q=E.split(" "),q[1]===F&&(C=B[I+" "+q[0]]||B["* "+q[0]])){!0===C?C=B[E]:!0!==B[E]&&(F=q[0],A.unshift(q[1]));break}if(!0!==C)if(C&&c["throws"])H=C(H);else try{H=C(H)}catch(K){q={state:"parsererror",
error:C?K:"No conversion from "+I+" to "+F};break a}}q={state:"success",data:H}}if(h)m.ifModified&&((v=r.getResponseHeader("Last-Modified"))&&(d.lastModified[f]=v),(v=r.getResponseHeader("etag"))&&(d.etag[f]=v)),204===a||"HEAD"===m.type?v="nocontent":304===a?v="notmodified":(v=q.state,l=q.data,n=q.error,h=!n);else if(n=v,a||!v)v="error",0>a&&(a=0);r.status=a;r.statusText=(b||v)+"";h?u.resolveWith(t,[l,v,r]):u.rejectWith(t,[r,v,n]);r.statusCode(G);G=void 0;p&&s.trigger(h?"ajaxSuccess":"ajaxError",
[r,m,h?l:n]);w.fireWith(t,[r,v]);p&&(s.trigger("ajaxComplete",[r,m]),--d.active||d.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,k,l,p,n,m=d.ajaxSetup({},b),t=m.context||m,s=m.context&&(t.nodeType||t.jquery)?d(t):d.event,u=d.Deferred(),w=d.Callbacks("once memory"),G=m.statusCode||{},x={},A={},J=0,v="canceled",r={readyState:0,getResponseHeader:function(a){var b;if(2===J){if(!h)for(h={};b=oc.exec(g);)h[b[1].toLowerCase()]=b[2];b=h[a.toLowerCase()]}return null==
b?null:b},getAllResponseHeaders:function(){return 2===J?g:null},setRequestHeader:function(a,b){var c=a.toLowerCase();J||(a=A[c]=A[c]||a,x[a]=b);return this},overrideMimeType:function(a){J||(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>J)for(b in a)G[b]=[G[b],a[b]];else r.always(a[r.status]);return this},abort:function(a){a=a||v;e&&e.abort(a);c(0,a);return this}};u.promise(r).complete=w.add;r.success=r.done;r.error=r.fail;m.url=((a||m.url||P)+"").replace(nc,"").replace(qc,S[1]+
"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=d.trim(m.dataType||"*").toLowerCase().match(L)||[""];null==m.crossDomain&&(l=Cb.exec(m.url.toLowerCase()),m.crossDomain=!(!l||l[1]===S[1]&&l[2]===S[2]&&(l[3]||("http:"===l[1]?"80":"443"))===(S[3]||("http:"===S[1]?"80":"443"))));m.data&&m.processData&&"string"!==typeof m.data&&(m.data=d.param(m.data,m.traditional));lb(Db,m,b,r);if(2===J)return r;(p=m.global)&&0===d.active++&&d.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=
!pc.test(m.type);f=m.url;m.hasContent||(m.data&&(f=m.url+=(Qa.test(f)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Bb.test(f)?f.replace(Bb,"$1_="+Pa++):f+(Qa.test(f)?"&":"?")+"_="+Pa++));m.ifModified&&(d.lastModified[f]&&r.setRequestHeader("If-Modified-Since",d.lastModified[f]),d.etag[f]&&r.setRequestHeader("If-None-Match",d.etag[f]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&r.setRequestHeader("Content-Type",m.contentType);r.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?
m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Eb+"; q=0.01":""):m.accepts["*"]);for(n in m.headers)r.setRequestHeader(n,m.headers[n]);if(m.beforeSend&&(!1===m.beforeSend.call(t,r,m)||2===J))return r.abort();v="abort";for(n in{success:1,error:1,complete:1})r[n](m[n]);if(e=lb(Ha,m,b,r)){r.readyState=1;p&&s.trigger("ajaxSend",[r,m]);m.async&&0<m.timeout&&(k=setTimeout(function(){r.abort("timeout")},m.timeout));try{J=1,e.send(x,c)}catch(z){if(2>J)c(-1,z);else throw z;}}else c(-1,"No Transport");
...
/^(?:input|select|textarea|keygen)/i;d.param=function(a,b){var c,e=[],f=function(a,b){b=d.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};void 0===b&&(b=d.ajaxSettings&&d.ajaxSettings.traditional);if(d.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){f(this.name,this.value)});else for(c in a)Ja(c,a[c],b,f);return e.join("&").replace(rc,"+")};d.fn.extend({serialize:function(){return d.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=
d.prop(this,"elements");return a?d.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!d(this).is(":disabled")&&tc.test(this.nodeName)&&!sc.test(a)&&(this.checked||!sb.test(a))}).map(function(a,b){var c=d(this).val();return null==c?null:d.isArray(c)?d.map(c,function(a){return{name:b.name,value:a.replace(Fb,"\r\n")}}):{name:b.name,value:c.replace(Fb,"\r\n")}}).get()}});d.ajaxSettings.xhr=function(){try{return new XMLHttpRequest}catch(a){}};var uc=0,Ba={},vc={0:200,1223:204},ka=
...
for(f in c)g.setRequestHeader(f,c[f]);b=function(a){return function(){b&&(delete Ba[h],b=g.onload=g.onerror=null,"abort"===a?g.abort():"error"===a?d(g.status,g.statusText):d(vc[g.status]||g.status,g.statusText,"string"===typeof g.responseText?{text:g.responseText}:void 0,g.getAllResponseHeaders()))}};g.onload=b();g.onerror=b("error");b=Ba[h]=b("abort");try{g.send(a.hasContent&&a.data||null)}catch(k){if(b)throw k;}},abort:function(){b&&b()}}});d.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
d.fn.andSelf=d.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return d});var wc=u.jQuery,xc=u.$;d.noConflict=function(a){u.$===d&&(u.$=xc);a&&u.jQuery===d&&(u.jQuery=wc);return d};"undefined"===typeof W&&(u.jQuery=u.$=d);return d});//# sourceMappingURL=jquery-2.1.1.min.map
